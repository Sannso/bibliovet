...
const $$Histologia = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Parasitologia" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, { "category": 2 })} ${maybeRenderHead()}<main class="w-full"> ${renderComponent($$result2, "ContentTopic", ContentTopic, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/reactComponents/contentTopic", "client:component-export": "ContentTopic" })} </main> ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
}, "E:/programacion/Sanss/BiblioVet/bibliovet/src/pages/histologia.astro", undefined);

const $$file = "E:/programacion/Sanss/BiblioVet/bibliovet/src/pages/histologia.astro";
const $$url = "/histologia";
